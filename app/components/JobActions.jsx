...
export default function JobActions({ job }) {
  ...
  return (
    <div className="panel p-4 space-y-3">
      ...
      {job.isLinkedIn && <p className="text-xs text-gray-500">Easy Apply runs in a Chrome window on this machine using your saved LinkedIn login. Progress shows in the dashboard log. Log in once from the dashboard first.</p>}
      <div>
